/**
 * @file Casino.jsx
 * @description Sección de promoción para la experiencia nocturna "Casino Tamanaco".
 */
...
/**
 * Componente Casino
 * @returns {JSX.Element} Sección promocional del Casino Tamanaco
 */
const Casino = () => {
  return (
    <section className="relative bg-slate-900 overflow-hidden" id="casino">
      <div className="flex flex-col md:flex-row min-h-[600px] md:h-[700px]">
        {/* Columna Izquierda: Imagen promocional de impacto */}
        ...
        {/* Columna Derecha: Marca, texto explicativo y puntos destacados */}
