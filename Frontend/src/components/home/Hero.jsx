/**
 * @file Hero.jsx
 * @description Sección principal de impacto visual (Hero Banner) para la página de inicio.
 * Muestra imagen de portada en pantalla completa, títulos de bienvenida y llamados a la acción (CTA).
 */
...
/**
 * Componente Hero
 * @returns {JSX.Element} Sección Hero desplegada en pantalla completa
 */
const Hero = () => {
  return (
    <section className="relative h-screen flex items-center overflow-hidden">
      {/* Imagen de fondo con overlay en degradado */}
      ...
      {/* Contenido principal de texto y botones CTA */}
      ...
      {/* Indicador animado de desplazamiento hacia abajo */}
